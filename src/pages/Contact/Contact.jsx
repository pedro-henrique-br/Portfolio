  ...
  return (
    <div style={{height: "100vh", width: "100vw", background: "#222222"}}>
      ...
      <div className="social__network--container">
        <a href="https://api.whatsapp.com/send/?phone=12988933305&text&type=phone_number"><FaWhatsapp className="icon"/></a>
        <a href="mailto:phbr10.12@gmail.com?subject=Olá-Pedro&body=?"><MdAttachEmail className="icon"/></a>
        <a href="https://www.linkedin.com/in/pedro-barbosa-dev/"><FaLinkedin className="icon"/></a>
      </div>
